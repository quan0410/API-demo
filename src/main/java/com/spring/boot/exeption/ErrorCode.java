...
public enum ErrorCode {
    ...
    PASSWORD_INVALID(1004, "Minimum password needs {min} characters", HttpStatus.BAD_REQUEST),
    USER_NOT_EXITED(1005, "User Not found", HttpStatus.NOT_FOUND),
    UNAUTHENTICATED(1006, "unauthenticated", HttpStatus.UNAUTHORIZED),
    UNAUTHORIZED(1007, "You do not have permission", HttpStatus.FORBIDDEN),
    INVALID_DOB(1008, "User must be over {min} years old", HttpStatus.BAD_REQUEST),
    ;
